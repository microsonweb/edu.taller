<div class="vehicles index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('id_model'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($vehicle['Vehicle']['patente']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($vehicle['Client']['id'], array('controller' => 'clients', 'action' => 'view', $vehicle['Client']['id'])); ?>
		</td>
		<td><?php echo h($vehicle['Vehicle']['id_model']); ?>&nbsp;</td>
		<td><?php echo h($vehicle['Vehicle']['active']); ?>&nbsp;</td>
