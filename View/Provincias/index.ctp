<div class="provincias index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $provincia['Provincia']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $provincia['Provincia']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
